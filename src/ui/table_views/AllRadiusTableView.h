#ifndef ALLRADIUSTABLEVIEW_H
#define ALLRADIUSTABLEVIEW_H
...
class AllRadiusTableView : public QTableView
{
    Q_OBJECT
  ...
  public:
    explicit AllRadiusTableView(QWidget *parent = nullptr);
